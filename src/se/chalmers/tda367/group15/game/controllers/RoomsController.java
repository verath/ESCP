...
public class RoomsController {
     ...
     * room.
     *
     * @param room The room that should be set as the starting room. Must not be
     *             null.
     */
     ...
     *
     * @param reference        The reference room. This room must have already been added.
     * @param room             The new room to add.
     * @param relativePosition The position relative to the reference room that the new room should be added at.
     */
     ...
     * @param g         The graphics context that can be used to render. However,
