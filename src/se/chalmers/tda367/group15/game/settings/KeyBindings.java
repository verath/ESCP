...
public class KeyBindings {
     ...
     *
     * @param key The key to find bindings for.
     * @param def The default value used should the key not exist.
     ...
     *
     * @param key     The key that should have a new binding.
     * @param keyCode The new keyCode for this key.
     */
     ...
     * testing.
     *
     * @param prefs A new Preference object to be used for storing keys.
     */
