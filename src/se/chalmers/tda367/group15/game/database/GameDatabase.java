...
public class GameDatabase {
     ...
     * needed.
     *
     * @param tempDatabase If set to true, the database used by this instance will be
     ...
     *
     * @return A database connection to be used to query the database.
     * @throws SQLException
     */
     ...
     *
     * @param score The score object to add to the database.
     */
     ...
     *
     * @param scores A list of InsertableScore that should be added to the database.
     */
     ...
     *
     * @param limit The max number of results, if set to less than 0 all results
     *              will be returned
     ...
     * InsertableEvent.
     *
     * @param event An event which type will be used to check for events that
     *              matches.
